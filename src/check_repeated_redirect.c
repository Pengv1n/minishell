...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/05/22 17:57:17 by eestelle          #+#    #+#             */
/*   Updated: 2022/05/22 17:57:19 by eestelle         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	check_repited_redirect(t_list *cmd_data)
{
	...
	while (cmd_data->next)
	{
		...
		{
			if (both_data_spec_symbols(cmd_data->content,
					cmd_data->next->content))
				return (1);
		}
